...
export const SITE_CONFIG = {
  ...
  hero: {
    ...
    description:
      '매장닥터는 사진 촬영 한 장으로 종이 영수증과 POS 정산서를 1.2초 내로 파싱하여 매출·매입 장부 및 실시간 마진율을 완성하는 AI 소상공인 장부 솔루션입니다. 장부 수기 작성 시간을 평균 92% 단축합니다.',
  },

  // 시네마틱 텍스트 섹션 (차별화 문구)
  cinematic: {
    text: '캐시노트가 카드 매출 및 입금 확인에 최적화되어 있다면, 매장닥터는 현금/종이 영수증 매입과 수동 고정 지출까지 완벽하게 파싱하여 매장의 실시간 진짜 순이익을 명확하게 산출합니다.',
  },
